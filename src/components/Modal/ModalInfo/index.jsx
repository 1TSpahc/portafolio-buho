...
export function ModalInfo ({ findProject }) {
  return (
        <>
            ...
            <motion.img src={findProject.project_image} alt={findProject.project_title} className='block w-[90%]  m-auto my-6 rounded-md md:w-[65%]' layoutId={findProject.id} exit={{ opacity: 1 }} />
